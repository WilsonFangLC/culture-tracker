...
export const OPERATION_PARAMETER_MAPPING: Record<OperationType, string[]> = {
  start_new_culture: ['temperature_c', 'volume_ml', 'location', 'cell_density', 'viability', 'hypothesized_growth_rate', 'hypothesized_doubling_time', 'hypothesized_density_limit', 'measured_growth_rate', 'measured_doubling_time', 'measured_density_limit', 'cell_type', 'operation_type'],
  passage: ['temperature_c', 'volume_ml', 'location', 'cell_density', 'viability', 'hypothesized_growth_rate', 'hypothesized_doubling_time', 'hypothesized_density_limit', 'measured_growth_rate', 'measured_doubling_time', 'measured_density_limit', 'parent_end_density', 'cell_type', 'operation_type'],
  freeze: ['temperature_c', 'volume_ml', 'location', 'cell_density', 'viability', 'hypothesized_growth_rate', 'hypothesized_doubling_time', 'hypothesized_density_limit', 'measured_growth_rate', 'measured_doubling_time', 'measured_density_limit', 'storage_location', 'parent_end_density', 'number_of_vials', 'total_cells', 'cell_type', 'operation_type'],
  thaw: ['temperature_c', 'volume_ml', 'location', 'cell_density', 'viability', 'hypothesized_growth_rate', 'hypothesized_doubling_time', 'hypothesized_density_limit', 'measured_growth_rate', 'measured_doubling_time', 'measured_density_limit', 'number_of_passages', 'cell_type', 'operation_type'],
  measurement: ['temperature_c', 'volume_ml', 'location', 'cell_density', 'viability', 'hypothesized_growth_rate', 'hypothesized_doubling_time', 'hypothesized_density_limit', 'measured_growth_rate', 'measured_doubling_time', 'measured_density_limit', 'measured_value', 'cell_type', 'operation_type'],
  split: ['temperature_c', 'volume_ml', 'location', 'cell_density', 'viability', 'hypothesized_growth_rate', 'hypothesized_doubling_time', 'hypothesized_density_limit', 'measured_growth_rate', 'measured_doubling_time', 'measured_density_limit', 'parent_end_density', 'cell_type', 'operation_type'],
...
export const ALL_PARAMETER_METADATA: Record<string, { 
  ...
  // Legacy parameters (to maintain backward compatibility)
